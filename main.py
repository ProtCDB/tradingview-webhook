...
def place_order(symbol, side):
    try:
        ...
        print("❌ Error al colocar orden de entrada:", str(e))
...
def place_close_order(symbol, side, size):
    try:
        ...
        print("❌ Error al colocar orden de cierre:", str(e))
...
def close_positions(symbol):
    ...
    try:
        ...
        long_pos = float(position.get("long", {}).get("available", 0) or 0)
        short_pos = float(position.get("short", {}).get("available", 0) or 0)
        ...
        print("❌ Error al cerrar posición:", str(e))
...
def webhook():
    try:
        ...
        print("❌ Error general en webhook:", str(e))
